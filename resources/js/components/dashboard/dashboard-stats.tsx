...
import { FileText, HeartHandshake, Megaphone, Newspaper } from 'lucide-react';
    ...
    return (
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div className="mt-4 flex flex-col gap-3">
                        ...
                        <div className="flex items-center space-x-2">
                            <Switch
                                ...
                                checked={
                                    filters.resource_member_only === '1' ||
                                    filters.resource_member_only === true
                                }
                                onCheckedChange={(checked) =>
                                    handleFilterChange(
                                        'resource_member_only',
                                        checked ? '1' : null,
                                    )
                                }
                            />
                            <Label
                                htmlFor="resource_member_only"
            ...
            <Card>
                ...
                <CardContent>
                    <div className="text-2xl font-bold">
                        {stats.total_opportunities_news}
                    </div>
                    <div className="mt-4 flex flex-col gap-3">
                        <div className="space-y-1.5">
                            <Label className="text-xs">Category</Label>
                        ...
                        <div className="flex items-center space-x-2">
                            <Switch
                                id="news_member_only"
                                checked={
                                    filters.news_member_only === '1' ||
                                    filters.news_member_only === true
                                }
                                onCheckedChange={(checked) =>
                                    handleFilterChange(
                                        'news_member_only',
            ...
            <Card>
                ...
                <CardContent>
                    <div className="text-2xl font-bold">
                        {stats.total_counselling_providers}
                    </div>
                    <div className="mt-4 flex flex-col gap-3">
                        <div className="space-y-1.5">
                        ...
                        <div className="flex items-center space-x-2">
                            <Switch
                                ...
                                checked={
                                    filters.counselling_member_only === '1' ||
                                    filters.counselling_member_only === true
                                }
                                onCheckedChange={(checked) =>
                                    handleFilterChange(
                                        'counselling_member_only',
                                        checked ? '1' : null,
                                    )
                                }
                            />
                            <Label
                                htmlFor="counselling_member_only"
                                className="text-xs font-normal"
                            >
                                Members Only
                            </Label>
                    ...
                    <div className="mt-4 flex flex-col gap-3">
                        ...
                        <div className="flex items-center space-x-2">
                            <Switch
                                ...
                                checked={
                                    filters.update_member_only === '1' ||
                                    filters.update_member_only === true
                                }
                                onCheckedChange={(checked) =>
                                    handleFilterChange(
                                        'update_member_only',
