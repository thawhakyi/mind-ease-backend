...
export default function OpportunitiesNewsCategories({
    categories,
}: {
    categories: Category[];
}) {
    ...
    return (
        <>
            <Head title="Opportunities & News Categories" />

            <div className="flex flex-col gap-6 p-6">
                <Heading
                    title="Category"
                    description="Manage categories for opportunities and news."
                />
...
OpportunitiesNewsCategories.layout = {
    breadcrumbs: [
        {
...
function CategoryRow({ category }: { category: Category }) {
    ...
    function submit(event: FormEvent<HTMLFormElement>) {
        ...
        form.patch(`/opportunities-news/categories/${category.id}`, {
            preserveScroll: true,
        });
    }
                        ...
                        <AlertDialogContent>
                            ...
                            <AlertDialogFooter>
                                ...
                                <AlertDialogAction
                                    onClick={() =>
                                        router.delete(
                                            `/opportunities-news/categories/${category.id}`,
                                            { preserveScroll: true },
                                        )
                                    }
                                >
